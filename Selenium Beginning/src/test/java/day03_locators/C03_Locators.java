...
3. Sayfada kac tane link oldugunu bulun.
    ...
    public static void main(String[] args) {
        ...
        // b. Sign in butonuna basin
        WebElement signInLinki=driver.findElement(By.linkText("Sign in")); // ana menu de sign in tiklar
        signInLinki.click();

        // c. email textbox,password textbox, and signin button elementlerini locate ediniz..
        WebElement emailTextBox=driver.findElement(By.id("session_email")); // locate ettik
        ...
        // bir web elementin uzerinde ne yazdigini gormek istersek webElementIsmi.getText() kullaniriz
        System.out.println(actualKullaniciAdiElementi.getText());
        String expectedUserMail="testtechproed@gmail.com";
         if (expectedUserMail.equals(actualKullaniciAdiElementi.getText())){ // get olmazsa olmaz
        ...
        //Linkleri yazdiralim
        // listemiz webelemntlerden olustugu icin direk yazdirirsak referanslari yazar
        //onun yerine foreachloop yapip her bir link webelementlerinin uzerindekini yaziyi yazdirmaliyiz
