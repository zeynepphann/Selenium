...
public class C03_windowHandles {
    ...
    public void test01(){
        ...
        WebElement sayfadakiYaziElementi=driver.findElement(By.xpath("//*[text()='Opening a new window']"));
...
//  ● Click Here butonuna basın.
        ...
        ile ilgili hicbir islem yapamaz
        yeni sayfada driveri calistirmak isterseniz
        once driver;i yeni sayfaya yollamalisiniz
         */
           /*
        eger kontrolsuz acilan bir tab veya windoe varsa
        o zaman sayfalarin window handle degerlerini elde etmem gerekir
        oncelikle iknci sayfa acilmadan once
        ilk sayfanin window handle degerini bir string'e atayalim
        */
        /*
        yeni sayfaya gecebilmek icin oncelikler ikincisayfawindowhandledegeri'ni
        bulmamiz gerekir bunun icin driver.getgetWindowHandles() methodunu kullanarak
        acik olan tum sayfalarin window handle degerlerini alip bir sete assign ederizz
        ilk sayfanin windowhandle degerini zaten biliyoruz Set'deki window handle degerlerini kontrol
        edip ilk sayfanin handle degerine esit olmayan
        ikinci sayfanin window handle degeri deriz
         */

        String ilkSayfaWindowHandleDegeri=driver.getWindowHandle();
        Set<String > windowHandleListesi=driver.getWindowHandles();
        System.out.println(windowHandleListesi);
        String ikinciSayfaWindowHandleDegeri="";

         for (String each:windowHandleListesi
              ) {
