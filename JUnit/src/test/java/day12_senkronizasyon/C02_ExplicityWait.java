...
public class C02_ExplicityWait extends TestBase {
    ...
    //4. Textbox’in etkin olmadigini(enabled) dogrulayın
       ...
       WebElement istEnableYaziElementi= driver.findElement(By.xpath("//*[text()=\"It's enabled!\"]"));
        Assert.assertTrue(istEnableYaziElementi.isEnabled());
       //7. Textbox’in etkin oldugunu(enabled) dogrulayın.
        Assert.assertTrue(enableKutusu.isEnabled()); // etkin oldugunu
